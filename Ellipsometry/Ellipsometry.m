...
%% Process_1
lightPlot1(t_start,t_end,dt,Projective_display);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Parameters_2
...
%% Process_2
lightPlot2(t_start,t_end,dt,omega_x,omega_y,omega_z,ds) ;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Parameters_3
n1 = 1;
n2 = 3.882 - 1i*0.019;
...
%% Process_3
CompleteProcess(t_start,t_end,dt,omega_x,omega_y,omega_z,n1,n2,ds,theta_min,theta_max,i_max,n_max);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function lightPlot1(t_start,t_end,dt,Projective_display)
figure()
...
function lightPlot2(t_start,t_end,dt,omega_x,omega_y,omega_z,ds) 
df = 1/(omega_y*2*pi);
dlambda = 1/df;
figure()
color = ["red","green","blue","cyan","yellow"];
...
function CompleteProcess(t_start,t_end,dt,omega_x,omega_y,omega_z,n1,n2,ds,theta_min,theta_max,i_max,n_max) 
df = 1/(omega_y*2*pi);
dlambda = 1/df;
